...
# Network for focal plane calculation using specialized autofocus light path
# training with only few image stacks
# source image stack is 256x256, 200 focal planes with 1um step
# An encoder network using 3 conv layers with Relu and 2 dense layers with 1 softmax output layes 
def AFNN(depth,filters=64,image_channels=1, use_bnorm=True):
    layer_count = 0
